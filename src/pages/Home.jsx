    ...
    return (
        <div className="bg-[#07090d] text-white overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <p className="text-gray-300 text-lg mb-8 max-w-xl">
                            ...
                            performance — without talk therapy, burnout spirals, or
            ...
            <ScrollReveal>
                ...
                <section className="py-28 px-6 bg-black">
                    <div className="max-w-5xl mx-auto text-center">
                        <h2 className="text-4xl mb-10  text-[#e6d3a3] drop-shadow-[0_0_10px_rgba(198,168,107,0.9)]">
                            Sound Familiar?
                        </h2>

                        <p className="text-gray-300 text-lg leading-relaxed">
                            You've climbed the corporate ladder. You've built teams, delivered
                            results, and earned your seat at the table. But somewhere along
                            the way, the cost of success quietly became too high.
                        </p>
            ...
            <section className="py-28 px-6">
                <div className="max-w-5xl mx-auto text-center">
                    <h2 className="text-4xl mb-6">A Smarter, Faster Path to Recovery</h2>

                    <p className="text-gray-300 text-lg mb-8">
                        The THRIVE Program is a 60-day hypnotherapy-based transformation
                        system designed for senior IT leaders to reprogram stress patterns
                        ...
                        >
                            ...
                            <div className="p-8 text-left">
                                <p className="text-gray-300 leading-relaxed mb-6">
                                    "I went from running on empty to leading with clarity and
                                    energy."
                                </p>

                                <p className="text-[#c6a86b] font-semibold">— VP Engineering</p>
                    ...
                    transition duration-500"
                        >
                            ...
                            <div className="p-8 text-left">
                                ...
                                <p className="text-[#c6a86b] font-semibold">— CTO</p>
            ...
            <section className="py-28 px-6 text-center">
                ...
                <p className="text-gray-300 mb-8">
                    Book a free 30-minute Clarity Call with Sheshi. No pressure, no pitch
                    just a focused conversation about where you are, where you want to be,
                    and whether the THRIVE program is the right fit for you.
                </p>
